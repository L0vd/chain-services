...
Create telegraf service for umee-testnet-node monitoring
```
...
## [Dashboard link](https://monitoring-dashboards.l0vd.com/d/Umee_testnet/umee-testnet-monitoring-by-l0vd?orgId=1&refresh=30s&from=now-1h&to=now)
