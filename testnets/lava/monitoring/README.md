...
* node validator address to COS_VALOPER ( like ```lava@valoper********```)
...
Create telegraf service for lava-testnet-node monitoring
```
...
## [Dashboard link](https://monitoring-dashboards.l0vd.com/d/Lava_testnet/lava-testnet-monitoring-by-l0vd?orgId=1&refresh=30s&from=now-1h&to=now)
