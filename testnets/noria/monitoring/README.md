...
* full path to noria binary to COS_BIN_NAME ( check ```which noria```)
...
## [Dashboard link](http://95.216.2.219:3000/d/Noria/noria-testnet-monitoring-by-l0vd?orgId=1&refresh=30s&from=now-5m&to=now)
