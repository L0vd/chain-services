...
```
. <(wget -qO- https://raw.githubusercontent.com/L0vd/chain-services/main/testnets/archway/monitoring/archway-monitoring-install.sh)
```
...
wget https://raw.githubusercontent.com/L0vd/chain-services/main/testnets/archway/monitoring/telegraf.conf
wget https://raw.githubusercontent.com/L0vd/chain-services/main/testnets/archway/monitoring/variables.sh
```
...
Create telegraf service for archway-testnet-node monitoring
```
...
## [Dashboard link](https://monitoring-dashboards.l0vd.com/d/Archway_testnet/archway-testnet-monitoring-by-l0vd?orgId=1&refresh=30s&from=now-1h&to=now)
