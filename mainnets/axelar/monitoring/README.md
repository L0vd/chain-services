...
```
. <(wget -qO- https://raw.githubusercontent.com/L0vd/chain-services/main/mainnets/axelar/monitoring/axelar-monitoring-install.sh)
```
...
wget https://raw.githubusercontent.com/L0vd/chain-services/main/mainnets/axelar/monitoring/telegraf.conf
wget https://raw.githubusercontent.com/L0vd/chain-services/main/mainnets/axelar/monitoring/variables.sh
```
...
Create telegraf service for axelar-mainnet-node monitoring
```
...
## [Dashboard link](https://monitoring-dashboards.l0vd.com/d/Axelar_mainnet/axelar-mainnet-monitoring-by-l0vd?orgId=1&refresh=30s&from=now-1h&to=now)
