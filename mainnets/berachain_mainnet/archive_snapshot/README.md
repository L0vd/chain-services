...
| --------- | --------- | --------- | --------- | --------- |
| 1053790  | 5.22GB  | nothing | kv | 2025-02-12T18:34:37 |
...
SNAP_NAME=$(curl -s https://berachain-snapshots.l0vd.com/mainnets/berachain_mainnet/mainnet-beacon-80094/ | egrep -o ">mainnet-beacon-80094.*\.tar.lz4" | tr -d ">")
curl https://berachain-snapshots.l0vd.com/mainnets/berachain_mainnet/mainnet-beacon-80094/${SNAP_NAME} | lz4 -dc - | tar -xf - -C $HOME/.beacond_mainnet_public
