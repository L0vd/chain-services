...
* full path to umee binary to COS_BIN_NAME ( check ```which umeed```)
...
Create telegraf service for umee-mainnet-node monitoring
```
...
## [Dashboard link](https://monitoring-dashboards.l0vd.com/d/Umee_mainnet/umee-mainnet-monitoring-by-l0vd?orgId=1&refresh=30s&from=now-1h&to=now)
