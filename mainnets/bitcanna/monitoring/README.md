...
Create telegraf service for bitcanna-node monitoring
```
...
sudo mv telegraf.conf /etc/telegraf/telegraf_bitcanna.conf
```
...
## [Dashboard link](http://95.216.2.219:3000/d/Bitcanna/bitcanna-monitoring-by-l0vd?orgId=1&refresh=30s&from=now-5m&to=now)
